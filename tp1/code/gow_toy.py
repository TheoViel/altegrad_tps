...
for w in range(2, 10):
    ...
    print(f"Density for window of size {w}: {g_.density()}")
...
core_numbers_igraph = dict(zip(g.vs["name"], g.coreness()))
print("\n.coreness() igraph method output : ")
print(core_numbers_igraph)
